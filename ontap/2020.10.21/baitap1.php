    ...
    <body>
        ...
        <div class="container">
            ...
            <form action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> class="formRegister" method="POST">
                ...
                <label>Phone:</label>
                <input type="text" name="phone" placeholder="Phone: 0909 000 000" class="fone" value="<?php echo $phone;?>"/><br>
                <label>Password:</label>
                <input type="password" name="password" placeholder="Password" class="pass" value="<?php echo $password;?>"/><br>
                <button type="submit" class="register-btn" name="submit" value="submit">Submit</button></br>
            </form>
            <?php
                // echo '<h3>View result register</h3>';
                echo $firstName;
                echo "<br>";
                echo $lastName;
                echo "<br>";
